...
export class CalendarPicker extends Component {
  ...
  handleOnPressDay(day) {
    ...
    this.props.pickedDay(day, currentMonth, currentYear);
  }
  ...
  handleOnPressPrevious() {
    ...
    this.props.handleOnPressPrevious(currentYear);
  }
  ...
  onNextYear = () => {
    this.handleOnPressNextYear()
  };

  onBackYear = () => {
    this.handleOnPressBackYear()
  };
